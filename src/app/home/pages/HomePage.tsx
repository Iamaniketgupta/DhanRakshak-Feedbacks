              ...
              <div className="p-6">
                <div className="flex items-start mb-5">
                  <div className="relative">
                    <Image
                      src={review.user_id.avatar || "https://media.istockphoto.com/id/1300845620/vector/user-icon-flat-isolated-on-white-background-user-symbol-vector-illustration.jpg?s=612x612&w=0&k=20&c=yBeyba0hUkh14_jgv1OKqIH0CCSWU_4ckRkAoy2p73o="}
                      width={50}
                      height={50}
